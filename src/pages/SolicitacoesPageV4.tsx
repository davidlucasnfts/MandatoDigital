                                    ...
                                    <div className="flex items-center gap-4 min-w-0">
                                      ...
                                      <div className="min-w-0">
                                        ...
                                        <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                                          ...
                                          {s.categoria && <span className="text-xs bg-slate-100 text-slate-600 px-2.5 py-0.5 rounded-full font-medium break-all">{s.categoria}</span>}
                                        </div>
                                      </div>
                                    </div>
          ...
          renderCard={(s) => (
            <div className="cursor-grab active:cursor-grabbing hover:shadow-md transition-shadow bg-white rounded-lg border border-slate-200 p-3">
              <div className="flex items-start justify-between">
                <div className="font-medium text-sm text-slate-800 mb-1 flex-1 break-all">{s.titulo}</div>
              ...
              <div className="text-xs text-slate-500 mb-2 truncate">{s.eleitor_nome}</div>
