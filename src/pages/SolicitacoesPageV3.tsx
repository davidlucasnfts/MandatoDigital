              ...
              <table className="w-full text-sm hidden sm:table" style={{ tableLayout: 'fixed' }}>
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50">
                    ...
                    <th className="text-left py-3 px-4 text-xs font-semibold text-slate-500 uppercase whitespace-nowrap" style={{ width: '30%' }}>Título</th>
                      ...
                      const rows = [
                        ...
                        >
                          <td className="py-3 px-2 align-top" style={{ width: '90px' }}>
                            <div className="flex flex-col gap-1">
                              <button onClick={(ev) => { ev.stopPropagation(); setEditSolicitacao(s); }} className="flex items-center justify-center gap-1 px-2 py-1 text-[10px] font-semibold bg-blue-600 text-white hover:bg-blue-700 rounded-lg shadow-sm" title="Editar">
                                <Pencil className="w-3 h-3" />Editar
                              </button>
                              <button onClick={(ev) => { ev.stopPropagation(); if (confirm('Excluir esta solicitação?')) remove(s.id); }} className="flex items-center justify-center gap-1 px-2 py-1 text-[10px] font-semibold bg-red-600 text-white hover:bg-red-700 rounded-lg shadow-sm" title="Excluir">
                                <Trash2 className="w-3 h-3" />Excluir
                              </button>
                            </div>
                          </td>
                          <td className="py-3 px-4 overflow-hidden" style={{ width: '30%' }}>
