                ...
                <div className="flex items-start gap-2">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={() => { if (confirm('Excluir este evento?')) { remove(e.id); fetch(); } }} className="text-xs cursor-pointer text-red-600"><Trash2 className="w-3.5 h-3.5 mr-2" /> Excluir</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
              </div>
