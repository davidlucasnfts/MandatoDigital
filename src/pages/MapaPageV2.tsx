                        ...
                        <Popup>
                          <div className="text-xs min-w-[200px]">
                            ...
                            <div className="mt-2 space-y-0.5 text-slate-500">
                              ...
                              {e.telefone && <div className="text-slate-400 break-all">{e.telefone}</div>}
                            </div>
          ...
          {eleitorSelecionado && (
            <div className="space-y-3 text-sm">
              ...
              <div className="space-y-1 text-slate-600">
                ...
                {eleitorSelecionado.cep && <p className="text-slate-400 break-all">CEP: {eleitorSelecionado.cep}</p>}
              </div>
              ...
              {eleitorSelecionado.tags && eleitorSelecionado.tags.length > 0 && (
                <div className="flex flex-wrap gap-1">
                  {eleitorSelecionado.tags.map(t => <span key={t} className="text-[10px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full break-all">{t}</span>)}
                </div>
              )}
              <div className="pt-2 border-t border-slate-100 space-y-1 text-slate-600">
                {eleitorSelecionado.telefone && <p className="break-all">Tel: {eleitorSelecionado.telefone}</p>}
