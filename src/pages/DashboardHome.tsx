...
export default function DashboardHome() {
  ...
  return (
    <div className="space-y-6">
              ...
              <Card className="cursor-pointer hover:shadow-md transition-shadow border-t-[3px]" style={{borderTopColor: s.color==='blue'?'#2563EB':s.color==='amber'?'#F59E0B':s.color==='orange'?'#F97316':'#059669'}} onClick={() => navigate(s.route)}>
                <CardContent className="p-5">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <div className={`flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[10px] font-medium ${trendBg} ${trendColor}`}>
                      <TrendIcon className="w-3 h-3" />{t.valor}%
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <motion.div custom={14} variants={fadeIn} initial="hidden" animate="visible" className="lg:col-span-2">
