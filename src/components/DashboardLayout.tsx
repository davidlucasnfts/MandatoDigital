  ...
  return [
    {
      ...
      items: [
        ...
        { to: '/dashboard/comunicacao/teste-v3', icon: MessageSquare, label: 'Comunicação V3', end: true },
      ],
    },
    {
      label: 'Gestão',
      items: [
        ...
        { to: '/dashboard/tarefas/teste-v2', icon: FileText, label: 'Tarefas V2', end: true },
        { to: '/dashboard/proposicoes', icon: Gavel, label: 'Proposições' },
        { to: '/dashboard/proposicoes/teste-v2', icon: Gavel, label: 'Proposições V2', end: true },
        { to: '/dashboard/produtividade', icon: TrendingUp, label: 'Produtividade' },
        { to: '/dashboard/produtividade/teste-v2', icon: TrendingUp, label: 'Produtividade V2', end: true },
        { to: '/dashboard/relatorios', icon: ReportAnalytics, label: 'Relatórios' },
        { to: '/dashboard/relatorios/teste-v2', icon: ReportAnalytics, label: 'Relatórios V2', end: true },
    ...
    ...(can.manageTeam ? [{
      ...
      items: [
        ...
        { to: '/dashboard/equipe/teste-v2', icon: Shield, label: 'Equipe V2', end: true },
