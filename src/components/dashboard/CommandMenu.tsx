...
export function CommandMenu() {
  ...
  const items: CommandItem[] = [
    ...
    { id: 'mapa', label: 'Mapa Territorial', icon: MapPin, action: () => navigate('/dashboard/mapa') },
    ...
    { id: 'proposicoes', label: 'Proposições', icon: FileText, action: () => navigate('/dashboard/proposicoes') },
    { id: 'enquetes', label: 'Enquetes', icon: Vote, action: () => navigate('/dashboard/enquetes') },
    { id: 'solicitacoes', label: 'Solicitações', icon: ClipboardList, action: () => navigate('/dashboard/solicitacoes') },
    { id: 'tarefas', label: 'Tarefas', icon: Clock, action: () => navigate('/dashboard/tarefas') },
  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-2 px-2.5 py-1.5 lg:px-3 lg:py-2 rounded-lg border border-slate-200 bg-white
          text-slate-500 text-xs lg:text-sm hover:border-slate-300 hover:bg-slate-50 transition-colors
